...
public class ReadAction {
    ...
    StringBuilder getBigDataWithIndex(String [] code , String [] codeName, int index) throws IOException {
        ...
        while ((oneLineFromBigData = br.readLine()) != null) { //읽어온 데이터가 null 값이 되면, 데이터가 더이상 없다는 것
            ...
            String info = input[index]; //index에 해당하는 데이터를 가져옴
    ...
    StringBuilder getBigDataWithIndex(String [] code , String [] codeName, int index,int index2) throws IOException {
